...
const Frieren = () => {
    ...
    return(
        <div id="container_frieren" className="relative">
            <div id="image-container_frieren" className="h-[400vh] w-full absolute top-[-70vh] bg-[rgb(18,3,20)] z-0 opacity-0 overflow-y-visible">
            ...
            <div className="pt-[180vh]">
                ...
                "> 
                    ...
                    sm:col-span-2 sm:mb-16">
                        <h2 className="text-5xl uppercase place-content-end font-bold text-fuchsia-800 my-10
                        
                        md:text-8xl md:my-0
                        "> Frieren </h2>
                        <h3 className="text-2xl text-fuchsia-600 mb-5
                            md:text-4xl
                    ...
                    " imgSrc="/characters/frieren/frieren3.jpg" /> 
                </div>
            </div>
        </div>
    )
