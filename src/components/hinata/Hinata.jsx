    ...
    return (
        <div ref={containerRef} className="bg-[rgba(18,3,20,0)]">
            ...
            ">
                ...
                <ImgZoom imgSrc="/characters/hinata/hinata3.jpg" otherClass="h-full" alt="Hinata's third image" ></ImgZoom>
            </div>
            ...
            <div id="secondImages-container_hinata" className="flex  flex-col w-10/12 mx-auto mt-24 gap-16 justify-center items-center h-[90vh] pb-5
                md:flex-row sm:pb-0
            ">
                <ImgZoom imgSrc="/characters/hinata/hinata4.jpg" otherClass="h-11/12" alt="Hinata's fourth image" ></ImgZoom>
                <ImgZoom imgSrc="/characters/hinata/hinata5.jpg" otherClass="h-8/12" alt="Hinata's fifth image" ></ImgZoom>
            </div>
